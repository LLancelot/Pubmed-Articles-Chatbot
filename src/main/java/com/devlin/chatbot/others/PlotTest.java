...
public class PlotTest implements ExampleChart<XYChart> {
    public static void main(String[] args) throws IOException {
//        ExampleChart<XYChart> exampleChart = new PlotTest();
//        XYChart chart = exampleChart.getChart();
////        new SwingWrapper<XYChart>(chart).displayChart();
//        saveJPGWithQuality(chart, "src/main/resources/graphs/1.jpg", 1);
        System.out.println(ChatBotSearchUtil.KEYWORD.BRUTE_FORCE.toString());
    }
    ...
    public XYChart getChart() {
        // Create Chart
        XYChart chart = new XYChartBuilder().width(800).height(600).title(getClass().getSimpleName()).xAxisTitle("Paper Count").yAxisTitle("Elapsed Time").build();
        // Series
        // @formatter:off
